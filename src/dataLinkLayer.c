...
//the four endpoint functions of the linkLayer: open, close, write and read
int llopen(char* door, LinkLayerRole role, int baudRate, int maxSendSize, int nTries, int timeout)
{
	initLinkLayer(door, role, baudRate, maxSendSize, nTries, timeout);
...
//output handling/creating functions
